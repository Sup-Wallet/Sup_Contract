#[test_only]
module adaptor_ember::adaptor_tests;

use adaptor_ember::adaptor::{Self, EmberAdaptor};
...
#[test]
fun test_ember_deposit_round_trip() {
    ...
    scenario.next_tx(ALICE);
    {
        ...
        wallet::grant_service_coin<EmberAdaptor, SUI>(&mut wallet, scenario.ctx());
...
#[test]
fun test_ember_redeem_round_trip() {
    let mut scenario = ts::begin(ALICE);
